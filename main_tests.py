...
OP_MOAT_FILE_NAME='output/updatedWeeklyShare_test.csv'
OP_GCS_FILE_PATH='output/updatedWeeklyShare_test.csv'
...
class TestStringMethods(unittest.TestCase):
    ...
    def test_postive(self):
        tst_path='output/updatedWeeklyShare_test.csv'
        ref_path='output/Weekly_moat_data_expected.csv'
